...
class ReflectorTest {
  ...
  @Test
  public void testUsage() throws InvocationTargetException, IllegalAccessException {
    Person person = new Person();
    Reflector reflector = new Reflector(Person.class);
    Invoker ageSet = reflector.getSetInvoker("age");
    ageSet.invoke(person, new Object[]{20});
    Invoker age = reflector.getGetInvoker("age");
    System.out.println(age.invoke(person, null));
  }
}
